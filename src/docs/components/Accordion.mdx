...
import { LoadedCode, GITHUB_DIR_COMP, GITHUB_STORY } from "@/components/LoadedCode";
import { AccordionDemo } from "./AccordionBlocks/Preview";
...
<TabProvider defaultName="preview">
  ...
  <TabContent name="code">
    <LoadedCode from={GITHUB_STORY("Accordion", "DefaultExpanded")} />
  </TabContent>
</TabProvider>
